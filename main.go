...
func main() {
	...
	r.GET("/api/sqlmap/agents/:id/manual-update-command", h.GetSqlmapManualUpdateCommand)
	r.POST("/api/sqlmap/agents/:id/uninstall", h.UninstallSqlmapAgent)
	r.GET("/api/sqlmap/agents/:id/manual-uninstall-command", h.GetSqlmapManualUninstallCommand)
	...
	r.POST("/api/path/agents/:id/update", h.UpdatePathAgentVersion)
	r.GET("/api/path/agents/:id/manual-update-command", h.GetPathManualUpdateCommand)
	r.POST("/api/path/agents/:id/uninstall", h.UninstallPathAgent)
	r.GET("/api/path/agents/:id/manual-uninstall-command", h.GetPathManualUninstallCommand)
